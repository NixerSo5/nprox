...
public class RedisUtil {
    ...
    public boolean objset(final String key, Object value) {
        Gson gson = new Gson();
        return set(key, gson.toJson(value));
    }

    public boolean objset(final String key, Object value, Long expireTime) {
        Gson gson = new Gson();
        return set(key, gson.toJson(value), expireTime);
    }
